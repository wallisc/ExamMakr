 ...
 */
public class MultipleChoiceView extends QuestionView implements KeyListener
{
    /**
     * Creates new form MultipleChoiceView
     */
    public MultipleChoiceView()
    {
        super();   
        
        item = Lookup.getDefault().lookup(MultipleChoiceApi.class).newItem();
        setEditView(false);

        initComponents();
        answerPanel.setLayout(new GridLayout(0, 1));

        answerPanel.add(new MultipleChoiceAnswerPanel(this));
        fillFields();
     ...
     */
    public MultipleChoiceView(MultipleChoiceApi nItem) 
    {
        super();
        item = nItem;
        setEditView(true);
    ...
    {
        MultipleChoiceApi mQuestion = (MultipleChoiceApi)inItem;
        questionHeaderPanel.fillFields(mQuestion);
        getAnswerPanel().fillFields(mQuestion); 
        examNavigatorPanel.refreshView(isEditView());
    }

    protected MultipleChoiceAnswerPanel getAnswerPanel()
    {
        return (MultipleChoiceAnswerPanel)(answerPanel.getComponent(0));
    }

    /**
     * Returns a MultipleChoice constructed from the fields in the gui
     * @return MultipleChoice constructed from the gui fields
     */
    @Override
    protected MultipleChoiceApi extractItem()
    {
        MultipleChoiceApi toAdd = Lookup.getDefault().lookup(
    ...
    private void initComponents() {
        ...
        addDocumentItem.setText(org.openide.util.NbBundle.getMessage(MultipleChoiceView.class, "MultipleChoiceView.addDocumentItem.text")); // NOI18N
